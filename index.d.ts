 ...
 */
export declare function Nexus(config: Record<string, ReturnType<typeof Singleton<any>>>): void;

/**
 * Access hooks from the app-wide lattice
 * @param hookName String name of the hook defined in Nexus
 * @returns [state, setState] tuple for the requested hook
 */
export declare function loadHook<T = any>(hookName: string): [T, (newState: T | ((prev: T) => T)) => void];
